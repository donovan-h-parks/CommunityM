...
class Extract16S(object):
  ...
  def hmmSearch(self, seqFile, threads, evalue, outputPrefix):
    ...
    os.system('hmmsearch --noali --cpu ' + str(threads) + ' -o ' + outputPrefix + '.bacteria.txt --tblout ' + outputPrefix + '.bacteria.table.txt -E ' + evalue + ' ' + self.bacteriaModelFile + ' ' + seqFile)
    os.system('hmmsearch --noali --cpu ' + str(threads) + ' -o ' + outputPrefix + '.bacteria.rev_comp.txt --tblout ' + outputPrefix + '.bacteria.table.rev_comp.txt -E ' + evalue + ' ' + self.bacteriaRevCompModelFile + ' ' + seqFile)

    if not self.bQuiet:
      print '    Identifying archaeal 16S'
    os.system('hmmsearch --noali --cpu ' + str(threads) + ' -o ' + outputPrefix + '.archaea.txt --tblout ' + outputPrefix + '.archaea.table.txt -E ' + evalue + ' ' + self.archaeaModelFile + ' ' + seqFile)
    os.system('hmmsearch --noali --cpu ' + str(threads) + ' -o ' + outputPrefix + '.archaea.rev_comp.txt --tblout ' + outputPrefix + '.archaea.table.rev_comp.txt -E ' + evalue + ' ' + self.archaeaRevCompModelFile + ' ' + seqFile)

    if not self.bQuiet:
      print '    Identifying eukaryotic 18S'
    os.system('hmmsearch --noali --cpu ' + str(threads) + ' -o ' + outputPrefix + '.euk.txt --tblout ' + outputPrefix + '.euk.table.txt -E ' + evalue + ' ' + self.eukModelFile + ' ' + seqFile)
    os.system('hmmsearch --noali --cpu ' + str(threads) + ' -o ' + outputPrefix + '.euk.rev_comp.txt --tblout ' + outputPrefix + '.euk.table.rev_comp.txt -E ' + evalue + ' ' + self.eukRevCompModelFile + ' ' + seqFile)
  ...
  def processPairs(self, pairs, threads, evalue, outputDir, sample):
    for i in xrange(0, len(pairs), 2):
      ...
      if not self.bQuiet:
        print '    Hits to left reads: ' + str(len(hits1)) + ' reads'
